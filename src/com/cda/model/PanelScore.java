	...
	public PanelScore(MaFenetre cdaFenetre) {
		...
		boutonQuitter.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				PanelScore.this.icoBoutonQuit = new ImageIcon(
						this.getClass().getResource("/images/bout-quitter-survol.png"));
		...
		boutonRejouer.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				super.mouseEntered(e);
				PanelScore.this.icoBoutonRejouer = new ImageIcon(
						this.getClass().getResource("/images/bout-rejouer-survol.png"));
			...
			public void mouseExited(MouseEvent e) {
				super.mouseExited(e);
				PanelScore.this.icoBoutonRejouer = new ImageIcon(
						this.getClass().getResource("/images/bout-rejouer.png"));
				PanelScore.this.imgBoutonRejouer = PanelScore.this.icoBoutonRejouer.getImage();
				boutonRejouer.repaint();
			}
		});
